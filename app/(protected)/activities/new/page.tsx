...
export default async function NewActivityPage() {
  ...
  return (
    <div className="max-w-2xl animate-slide-up">
      ...
      <form action={addActivityAction} className="mt-6 space-y-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-darkTheme-border dark:bg-darkTheme-card">
