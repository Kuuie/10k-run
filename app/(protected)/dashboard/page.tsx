  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid gap-4 md:grid-cols-3 animate-slide-up delay-3">
        <div className="col-span-2 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm animate-slide-up delay-3 dark:border-darkTheme-border dark:bg-[rgba(16,185,129,0.18)]">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm animate-slide-up delay-4 dark:border-darkTheme-border dark:bg-[rgba(16,185,129,0.18)]">
